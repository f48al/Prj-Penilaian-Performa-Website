...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <div class="row table-responsive mt-3" style="font-size: 13px;">
            <table id="table_id" class="table table-striped table-hover table-bordered border-light text-center align-middle w-100">
                ...
                <tbody>
                    @foreach ($datas as $data)
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('penilaian-bawahan.create', [$form->idPenyusunanKPI, 1]) }}" class="text-decoration-none">Triwulan I</a><br/>
                                <a href="{{ route('penilaian-bawahan.create', [$form->idPenyusunanKPI, 2]) }}" class="text-decoration-none">Triwulan II</a><br/>
                                <a href="{{ route('penilaian-bawahan.create', [$form->idPenyusunanKPI, 3]) }}" class="text-decoration-none">Triwulan III</a><br/>
                                <a href="{{ route('penilaian-bawahan.create', [$form->idPenyusunanKPI, 4]) }}" class="text-decoration-none">Triwulan IV</a>
                            </td>
                            <td>
