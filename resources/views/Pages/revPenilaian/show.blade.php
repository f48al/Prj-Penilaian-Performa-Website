...
@section('content')
    ...
    <div class="container mt-5" style="font-size: 13px;">
                ...
                <tbody>
                    @foreach ($data->targetKinerjas as $target_kinerja)
                        ...
                        <tr>
                            ...
                            <td>{{ $target_triwulan->realisasi_atasan }}</td>
                            <td>0</td>
                            <td>0</td>
                            <td>0</td>
                            <td>
        ...
        <div class="row my-2 text-end">
            <a class="link link-danger" href="{{ route('penilaian-bawahan.create', [$data->idPenyusunanKPI, $ke]) }}"><b>Edit Nilai...</b></a>
        </div>
        <div class="row my-3">
            <div class="col text-center" style="font-size: 13px">
                <button type="button" class="btn btn-danger px-4 mx-3" style="border-radius: 15px" disabled><b>Revisi</b></button>
                <a class="btn btn-primary px-4 mx-3" role="button" href="{{ route('review-penilaian.update', [$data->idPenyusunanKPI, $ke]) }}" style="border-radius: 15px"><b>Approve</b></a>
            </div>
        </div>
        <div class="row">
